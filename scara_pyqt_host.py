...
class ScaraHost(QMainWindow):
    ...
    def build_left_panel(self):
        ...
        self.home_btn = QPushButton("光电回零")
        self.set_home_btn = QPushButton("软件设原点")
        ...
        self.set_home_btn.clicked.connect(lambda: self.send_command("SETHOME"))
        ...
        safety_layout.addWidget(self.set_home_btn, 2, 0, 1, 2)
        safety_layout.addWidget(self.pen_up_btn, 3, 0)
        safety_layout.addWidget(self.pen_down_btn, 3, 1)
